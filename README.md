# Foundry Smart Contract MoodNFT

This is a section of the Cyfrin Foundry Solidity Course.

-   [Foundry Smart Contract MoodNFT](#foundry-smart-contract-moodNFT)
...
```
git clone https://github.com/sasorivvs/MoodNFT-foundry
cd MoodNFT-foundry
forge build
```
...
```
cast send <MOODNFT_CONTRACT_ADDRESS> "flipMood(tokenId)" --private-key <PRIVATE_KEY> --rpc-url $SEPOLIA_RPC_URL
```
